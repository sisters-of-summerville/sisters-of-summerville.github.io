const CACHE = "sisters-chaos-arcade-v9";
const ASSETS = [
  "./", "index.html", "styles.css?v=9", "game.js?v=9", "manifest.webmanifest",
  ...
  "assets/radar.png", "assets/meemaw.png", "assets/beau.png", "assets/belle.png"
];
